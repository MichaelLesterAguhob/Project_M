                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="modal-line">
                                ...
                                <a onclick="showOrders(2);" id="ordersNav2" class="text-light">Order(s)</a>
                                <a onclick="backToOrdering(2);" id="backToHome2" class="text-light"><i class="fa-sharp fa-solid fa-left-long"></i> Back
                                </a>
                            </div>

                            <div class="modal-line">
                                <i class="fas fa-spinner fa-spin"></i>
                                <a onclick="showOrders(4);" id="preparingNav2" class="text-light">Preparing Order(s)</a>
                                <a onclick="backToOrdering(4);" id="backToHome4" class="text-light">
                            ...
                            <div class="modal-line">
                                ...
                                <a onclick="showOrders(6);" id="completedNav2" class="text-light">Completed Order(s)</a>
                                <a onclick="backToOrdering(6);" id="backToHome6" class="text-light">
                                    <i class="fa-sharp fa-solid fa-left-long"></i> Back
                                </a>
                            </div>
        ...
        <div class="row" id="orderingDisplay">
            ...
            <div class="col-lg-2 text-center mb-5" id="category">
                ...
                <div class="form-group" id="searchBox">
                    ...
                    <p id="searchMsg"></p>
                    <input type="text" class="form-control" placeholder="Search here..." id="searchInput" onkeypress="">

                    <button class="btn btn-primary mt-2" style="display:inline-flex;" id="search">
            ...
            <div class="modal fade" id="orderingModal">
                <div class="modal-dialog" id="orderingModalDialog">
                    <div class="modal-content" id="orderingModalContent">
                        ...
                        <div class="modal-header bg-light text-dark mt-2" id="orderingModalHeader">
                        ...
                        <div class="modal-body" id="orderingModalBody">
                            <div style="text-align: center;" class="mb-3">
                                ...
                                <img class="border" src="icons/logo.png" alt="product image" id="prodImage">
                                <br>

                                <input type="text" id="b1t1" class="form-control-sm mb-2" disabled>
                            </div>

                            <form method="post" enctype="multipart/form-data" id="orderingForm" class="form-group">
                                <input type="hidden" id="prodID" class="md-3">

                                <label for="prodName">Product Name</label>
                                <input type="text" id="prodName" class="form-control-lg mb-2" style="font-weight: bolder;" readonly>
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                        ...
                                        <br>
                                        <input type="number" id="AoQnty" class="form-control" value="0" onclick="addOnsQntyClick('1');" onchange="addOnsQntyChange('1');">
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <br>
                                        <button type="button" id="AoBtn" class="btn btn-success btn-md" style="width: 100%;" onclick="addOnsNext('flavor1AddOns');">Save
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="pairSelection">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <br>
                                            <input type="number" id="AoQnty2" class="form-control" value="0" onclick="addOnsQntyClick('2');" onchange="addOnsQntyChange('2');">
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <br>
                                            <button type="button" id="AoBtn2" class="btn btn-success btn-md" style="width: 100%;" onclick="addOnsNext('flavor2AddOns');">Save
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <input class="form-control form-control-lg" type="text" id="price" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        <input type="number" id="qnty" class="form-control-lg" value="1">
                                    </div>

                                    <div class="col-4" id="qntybtn">
                                        <button type="button" class="btn btn-lg btn-success" id="plus"> +
                                        </button> &nbsp;
                                        <button type="button" class="btn btn-lg btn-warning" id="minus"> -
                                        </button>
                                    </div>
                                </div>

                                <div class="row mt-5 btnCont">
                                    <button type="button" class="btn btn-lg btn-success" style="width:90%;" onclick="orderDone();">DONE</button>
                                </div>
            ...
            <div class="col-lg-3">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6 text-center">
                        ...
                        <input type="text" id="orderTotal" class="form-control-lg" value="0" readonly>
                    </div>

                    <div class="col-6 text-center">
                        <button type="button" id="placeOrder" class="btn btn-lg btn-success mt-4">Place Order</button>
                    </div>
                ...
                <button id="cancelCurrentOrder" class="btn btn-danger btn-lg mb-2" data-bs-toggle="modal" data-bs-target="#cancelOrderModal">Cancel Order
                </button>
            </div>
                ...
                <div class="modal-dialog" id="messageModalDialog">
                    <div class="modal-content text-center" id="messageModalContent">
                        ...
                        <div class="modal-footer" id="messageModalFooter">
                            <button type="button" class="btn btn-lg btn-success" id="placeNow" onclick="placeOrder();" data-bs-dismiss="modal">PLaceOrder</button>
                ...
                <div class="modal-dialog" id="messageModalDialog">
                    <div class="modal-content text-center" id="messageModalContent">
                        ...
                        <div class="modal-footer" id="messageModalFooter">
                            ...
                            <button type="button" class="btn btn-lg btn-danger" id="CCOrder">
                                Confirm
                            </button>
